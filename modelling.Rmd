...
cleveland = read_csv("./data/cleveland.csv")
hungary = read_csv("./data/hungarian.csv")
long_beach = read_csv("./data/long_beach_va.csv")
switzerland = read_csv("./data/switzerland.csv")
```