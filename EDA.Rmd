...
ggplot(combined_df, aes(x = cp, fill = num)) +
  ...
  theme_minimal()
```
we can see that for those who have defect of thalassemia (6 and 7), they tend to have the disease. On the other hand, for those who have normal thalassemia, Some other factors may have influenced whether they got the disease, as participants in Switzerland and Hungary presented two extreme and opposing outcomes.
```{r}
...
this observation is consistent, if people experienced exercise-induced angina (1), they are at high risk of heart disease.
```{r}
