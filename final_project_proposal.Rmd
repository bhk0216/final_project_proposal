...
1. The Influence of Age and Lifestyle Factors on Heart Disease Across International Datasets: narrows down the analysis to age and lifestyle-related variables (e.g., chest pain type, cholesterol, exercise-induced angina).

2. Regional Patterns in Heart Disease Diagnostic Attributes: focusing on comparing the prevalence and distribution of key diagnostic attributes (like age, cholesterol, etc.) across the four datasets.
