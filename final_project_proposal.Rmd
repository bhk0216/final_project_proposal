...
* Visualizations
    * Correlation Heatmap: A heatmap will highlight correlations between variables, helping to identify pairs of features that might be redundant due to high correlation. This can guide feature selection and highlight which variables are more informative for predicting heart disease.
    * Interactive Variables Visualization: Use Plotly for interactive scatter plots and box plots, enabling deeper exploration of specific relationships (e.g., thalach vs. age, categorized by presence or absence of heart disease). This allows users to explore the data dynamically, focusing on specific variables or subgroups.
    * QQ Plot and Residual Plots: Diagnostic plots, including a QQ plot, will assess model assumptions. Residual vs. fitted value plots can further validate if linear model assumptions hold.    
