...
## Data Sources (Stella)
The Heart Disease datasets were obtained from UC Irvine's Machine Learning Repository that can be accessed [here](https://archive.ics.uci.edu/dataset/45/heart+disease). This directory includes four datasets related to heart disease diagnosis, with all attributes represented as numeric values. The data was gathered from the following four locations:
